const AddressForm =
  () => `<p class="input custom-field-receiverName tfg-custom-addressForm">
...
export const SuburbField =
  () => `<p class="input custom-field-neighborhood tfg-custom-addressForm">
<label>Suburb</label>
...
export const PickupComplementField = () => `
  <p id="box-pickup-complement" class="input custom-field-complement tfg-custom-addressForm text">
    <label>Mobile number</label>
    <input id="custom-pickup-complement" class="input-xlarge success" type="tel" field="complement"/>
  </p>`
